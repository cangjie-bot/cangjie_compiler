...
private:
    ...
    /**
     * Add SRet, do necessary conversions, and push type arguments to the args.
     * Insert SRet or TypeInfo if necessary.
     * Return a vector of converted arguments.
     */
    std::vector<llvm::Value*> CreateFuncArgs(const CGFunctionType& calleeType,
     ...
     */
    llvm::Value* CreateSRetUnknownSize(const CHIR::Type& returnCHIRType, const CHIR::Type& retValType);
    /**
