...
std::string GenDumpPath(
    const std::string& output, const std::string& pkgName, const std::string& subName, const std::string& srcFileName, const std::string& suffix = ".ll");
