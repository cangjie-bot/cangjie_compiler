...
// objc.lang
constexpr auto OBJ_C_POINTER_TYPE = "ObjCPointer";
constexpr auto OBJ_C_FUNC_TYPE = "ObjCFunc";
constexpr auto OBJ_C_FUNC_GET_FPOINTER = "unsafeGetFunctionPointer";
constexpr auto OBJ_C_BLOCK_TYPE = "ObjCBlock";
...
{
    static auto result = GetObjCLangDecl<ASTKind::STRUCT_DECL>(OBJ_C_POINTER_TYPE);
    return result;
}

Ptr<StructDecl> InteropLibBridge::GetObjCFuncDecl()
{
    static auto result =  GetObjCLangDecl<ASTKind::STRUCT_DECL>(OBJ_C_FUNC_TYPE);
    return result;
}

Ptr<ClassDecl> InteropLibBridge::GetObjCBlockDecl() {
    static auto result = GetObjCLangDecl<ASTKind::CLASS_DECL>(OBJ_C_BLOCK_TYPE);
    return result;
}
