 ...
 * @file
 *
 * This file implements typechecking pipeline for CJMapping which is used in Objective-C side.
 */
...
{
    auto checker =
        HandlerFactory<TypeCheckContext>::Start<CheckInheritanceInterface>().Use<CheckGeneric>().Use<CheckMemberTypes>(
            InteropType::CJ_Mapping);
