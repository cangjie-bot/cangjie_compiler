...
OwnedPtr<AST::MemberAccess> JavaDesugarManager::GenThisMemAcessForSelfMethod(Ptr<FuncDecl> fd, Ptr<InterfaceDecl> interfaceDecl, GenericConfigInfo* genericConfig)
{
    Ptr<Ty> interfaceTy = nullptr;
    Ptr<Ty> funcTy = nullptr;
    if (genericConfig) {
        // init interfaceTy
