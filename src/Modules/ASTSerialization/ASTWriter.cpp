        ...
        switch (node->astKind) {
            ...
            case ASTKind::CLASS_DECL: {
                ...
                if (cd->platformImplementation) {
                  // Members of this common class was copied to platform class,
                  // so common parent should not be deserialized.
                  cd->doNotExport = true;
                }
            ...
            case ASTKind::FUNC_DECL: {
                ...
                if (fd->platformImplementation) {
                  // This decl was replaced with more platform, therefore must not be serialized
                  fd->doNotExport = true;
                }
                for (auto &param : fd->funcBody->paramLists[0]->params) {
