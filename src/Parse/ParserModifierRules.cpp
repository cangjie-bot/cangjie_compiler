...
#define CR(tk, ...)                                                                                                    \
    {                                                                                                                  \
        tk, (const TokenKind[]){__VA_ARGS__}, sizeof((const TokenKind[]){__VA_ARGS__}) / sizeof(TokenKind)             \
    }
#define CR_EMPTY(tk)                                                                                                   \
    {                                                                                                                  \
        tk, nullptr, 0                                                                                                 \
...
#define CR_ARR(tk, arr)                                                                                                \
    {                                                                                                                  \
        tk, arr, ARRAY_SIZE(arr)                                                                                       \
    }
...
// get size of array
#define SCOPE_ENTRY(sk, arr)                                                                                           \
    {                                                                                                                  \
        sk, arr, ARRAY_SIZE(arr)                                                                                       \
    }
#define SCOPE_ENTRY_EMPTY(sk)                                                                                          \
    {                                                                                                                  \
        sk, nullptr, 0                                                                                                 \
    }
...
std::optional<AST::Attribute> GetAttributeByModifier(TokenKind tokenKind)
{
    ...
    static const AST::Attribute attrTable[] = {
