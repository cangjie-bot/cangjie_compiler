...
void Ohos_CJNATIVE::AddCRuntimeLibraryPaths()
{
    ...
    AddCRuntimeLibraryPath(FileUtil::JoinPath(driver.cangjieHome, "lib/linux_ohos_aarch64_cjnative"));
}
...
void Ohos_CJNATIVE::GenerateLinkOptions(Tool& tool)
{
    ...
    tool.AppendArg("-L" + FileUtil::JoinPath(driver.cangjieHome, "lib/linux_ohos_aarch64_cjnative"));
