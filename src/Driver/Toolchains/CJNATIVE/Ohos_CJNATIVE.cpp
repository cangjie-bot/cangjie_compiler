...
void Ohos_CJNATIVE::AddCRuntimeLibraryPaths()
{
    ...
    AddCRuntimeLibraryPath(FileUtil::JoinPath(driver.cangjieHome, "third_party/ohos_sdk_crt/aarch64-linux-ohos"));
}
...
void Ohos_CJNATIVE::GenerateLinkOptions(Tool& tool)
{
    ...
    tool.AppendArg("-L" + FileUtil::JoinPath(driver.cangjieHome, "third_party/ohos_sdk_crt/aarch64-linux-ohos"));
