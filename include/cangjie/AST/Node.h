...
struct MacroDecl : Decl {
    Position leftParenPos;       /**< Position of '('. not set by compiler, do not know why this exists */
    Position rightParenPos;      /**< Position of ')'. not set by compiler, do not know why this exists */
