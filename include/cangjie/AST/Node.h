...
struct ModalASTInfo {
    void SetLocal(LocalModalAST loc, const Position& localBegin)
    {
        this->local = loc;
        this->localPos = localBegin;
    }
    ...
    {
        return localPos + ToString(local).size();
    }
    Position End() const;
    bool HasLocal() const;
    LocalModalAST Local() const
    {
        return local;
    }
...
struct Type : Node {
    ...
    ModalASTInfo modal; /**< Modal type info, Optional */
 ...
 */
struct FuncParam : FuncParamBase {
    ...
    FuncParam() : FuncParamBase(ASTKind::FUNC_PARAM)
    {
    }
    void Clear() noexcept override
    {
...
protected:
    explicit FuncParam(ASTKind astKind) : FuncParamBase(astKind)
    {
    }
};
...
struct FuncDecl : Decl {
    Position leftParenPos;       /**< Position of '('. Generated by parser*/
    Position rightParenPos;      /**< Position of ')'. Generated by parser*/
    ModalASTInfo modal;          /**< Position of @local. Generated by parser */
...
struct StructDecl : InheritableDecl {
    ...
    void SetIsCopyType()
    {
        derivedFromCopyType = true;
    }
    bool IsCopyType() const
    {
        return derivedFromCopyType;
    }
...
private:
    ...
    bool derivedFromCopyType{false};
};
...
struct RefExpr : NameReferenceExpr {
    ...
    ModalASTInfo modal; /**< Modal type info, only available if the reference is a type name, i.e. this is a
        constructor call or type conversion. */
    bool isThis{false};
    bool isSuper{false};
