...
inline const std::string CLASS_RESUMPTION = "Resumption";
inline const std::string CLASS_RESUMPTION_INTERNAL = "ResumptionInternal";
inline const std::string CLASS_HANDLER_FRAME = "HandlerFrame";
inline const std::string CLASS_DEFERRED_FRAME = "DeferredFrame";
