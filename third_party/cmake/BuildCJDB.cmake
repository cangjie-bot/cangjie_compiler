...
if(WIN32)
    ...
    if(DARWIN)
        ...
        if (TARGET_PYTHON_PATH)
            list(APPEND LLDB_CMAKE_ARGS -DPython_EXECUTABLE=${TARGET_PYTHON_PATH}/bin/python3)
        endif()
...
if(CMAKE_CROSSCOMPILING AND WIN32)
    ...
    set(TARGET_PYTHON_PATH $ENV{TARGET_PYTHON_PATH})
    list(APPEND LLDB_CMAKE_ARGS ${LLDB_CMAKE_ARGS}
        -DLLDB_PYTHON_RELATIVE_PATH=./lib/python${MAJOR_VERSION}.${MINOR_VERSION}/site-packages
...
if(CMAKE_CROSSCOMPILING AND WIN32)
    install(
        DIRECTORY ${LLVM_GC_LLDB_INSTALL_PREFIX}/lib/python${MAJOR_VERSION}.${MINOR_VERSION}
        DESTINATION tools/lib
        USE_SOURCE_PERMISSIONS
        PATTERN ${LLVM_GC_LLDB_INSTALL_PREFIX}/lib/python${MAJOR_VERSION}.${MINOR_VERSION}/site-packages/lldb/lldb-argdumper.exe EXCLUDE
    )
else()
    install(
        DIRECTORY ${LLVM_GC_LLDB_INSTALL_PREFIX}/lib/python${MAJOR_VERSION}.${MINOR_VERSION}
