...
if (DARWIN)
    ...
    if(Python3_VERSION MATCHES "^([0-9]+)\\.([0-9]+)")
        set(TARGET_PATHON_VERSION "${CMAKE_MATCH_1}")
    endif()
endif()
...
if(CMAKE_CROSSCOMPILING AND WIN32)
    ...
    list(APPEND LLDB_CMAKE_ARGS ${LLDB_CMAKE_ARGS}
        ...
        -DPython3_INCLUDE_DIRS=${TARGET_PYTHON_PATH}/include/python${TARGET_PATHON_VERSION}
        -DPython3_LIBRARIES=${TARGET_PYTHON_PATH}/python${TARGET_PATHON_VERSION}.dll
    )
