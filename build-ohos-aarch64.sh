...
# # 3 打包 ohos cangjie-sdk
# # 3.1 打包 ohos runtime
# cp -rf ${WORKSPACE}/cangjie_runtime/runtime/output/common/linux_ohos_${BUILD_TYPE}_aarch64/{lib,runtime} ${WORKSPACE}/cangjie_compiler/output-aarch64-linux-ohos;
# # 3.2 打包 ohos std
# cp -rf ${WORKSPACE}/cangjie_runtime/stdlib/output-aarch64-linux-ohos/* ${WORKSPACE}/cangjie_compiler/output-aarch64-linux-ohos;
# zip -o -X $WORKSPACE/software/cangjie-stdx-ohos-x86_64-${cangjie_version}.${stdx_version}.zip
